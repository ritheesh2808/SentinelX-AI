...
export const DashboardHome: React.FC = () => {
  ...
  // Mock stats for SOC Dashboard look
  const stats = [
    {
      title: 'Current Threat Index',
      value: 'ELEVATED',
    ...
    {
      title: 'Agent Integrity Status',
      value: '99.8% SECURE',
      color: 'text-emerald-500 border-emerald-500/20 bg-emerald-500/5',
      trend: 'All nodes synchronized',
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-[#1e293b] bg-[#131c2e] p-6 space-y-6">
          ...
          <div className="border-t border-[#1e293b] pt-4 text-xs text-[#475569] space-y-2">
            <div>
              Platform Build ID: <span className="text-[#94a3b8] font-mono">v1.0.0-sprint-06</span>
            </div>
            <div>
